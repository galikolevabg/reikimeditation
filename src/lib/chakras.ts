...
export const musicTracks = [
  // Local MP3 files - your uploaded music
  {
    id: 'chakra-heart',
    name: 'Chakra Meditation - Heart of Reiki',
  ...
  {
    id: 'tibetan-local',
    name: 'Tibetan Indian Meditation',
  ...
  {
    id: 'ambient',
    name: 'Reiki Healing Music (SoundCloud)',
    nameBg: 'Рейки лечебна музика (SoundCloud)',
  ...
  {
    id: 'nature',
    name: 'Relaxing Nature (SoundCloud)',
    nameBg: 'Релаксираща природа (SoundCloud)',
  ...
  {
    id: 'frequencies',
    name: 'Healing Frequencies (SoundCloud)',
    nameBg: 'Лечебни честоти (SoundCloud)',
  ...
  {
    id: 'cleanse',
    name: '396Hz Cleanse Energy (SoundCloud)',
    nameBg: '396Hz Пречистване (SoundCloud)',
